...
public class Point implements Comparable<Point> {
    ...
    public int compareTo(Point that) {
        if (this.y == that.y && this.x == that.x)
            return 0;
                ...
                this.y - that.y == 0 && this.x - that.x < 0)
            return -1;
        else return 1;
        /* YOUR CODE HERE */
    }
    ...
    public static void main(String[] args) {
        ...
        assert point1.slopeTo(point2) > 0;
        assert point1.slopeTo(point5) == +0.0;
        assert point1.slopeTo(point4) > 0;
        assert point1.slopeTo(point3) < 0;
        assert point1.slopeTo(point6) == Double.POSITIVE_INFINITY;
        assert point0.slopeTo(point1) == Double.NEGATIVE_INFINITY;
        assert point0.compareTo(point1) == 0;
    }
}
